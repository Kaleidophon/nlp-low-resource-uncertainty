...
CLINC_MODEL_PARAMS = {
    ...
    "bayesian_lstm": {
        ...
        "vocab_size": 30522,
        "output_size": 151,
        "prior_sigma_1": 0.7067,
        "prior_sigma_2": 0.5398,
        "prior_pi": 1,
        "posterior_mu_init": 0.1103,
    ...
    "variational_lstm": {
        ...
        "hidden_size": 1500,
        "input_size": 1500,
        "embedding_dropout": 0.2299,  # dropout_x, Large model Gal & Ghrahramani (2016)
        "layer_dropout": 0.2166,  # dropout_i / dropout_o, Large model Gal & Ghrahramani (2016)
